...
const QString DEF_SHORTCUT_CLOSE = "Ctrl+Q";
...
void ShortcutManager::loadSettings()
{
    ...
    setShortcut(shortcutSettings->value(KEY_SHORTCUT_CLOSE, DEF_SHORTCUT_CLOSE).toString(),Config::shortcutClose, Config::localShortcut);
